...
<div class="sidebar d-none d-lg-block p-3" id="sidebar">
  ...
  <ul class="list-unstyled">
    <li class="mb-2">
      <a href="https://exeteam.net/admin" class="d-block text-decoration-none py-2 px-3 rounded <?php if($current_page == 'admin') echo 'bg-dark'; ?>">  
    ...
    <li class="mb-2">
      ...
      <ul id="ModSubmenu" class="list-unstyled collapse interrior">
        <a href="lessons/" class="text-decoration-none rounded"><li>Dersler</li></a>
        <a href="lessons/add_lessons" class="text-decoration-none rounded"><li>Ders Ekle</li></a>
        <a href="lessons/add_category" class="text-decoration-none rounded"><li>Kategori Ekle</li></a>
        <a href="lessons/add_teacher" class="text-decoration-none rounded"><li>Öğretmen Ekle</li></a>
      </ul>
    </li>
    <li class="mb-2">
      <a class="d-block text-decoration-none py-2 px-3 rounded collapsed" 
      ...
      <ul id="userSubmenu" class="list-unstyled collapse interrior">
        <a href="users/summary" class="text-decoration-none rounded"><li>Kullanıcı Özeti</li></a>
        <a href="users/manage" class="text-decoration-none rounded"><li>Kullanıcılar</li></a>
      </ul>
    </li>
    <li class="mb-2">
      <a href="logs/" class="d-block text-decoration-none py-2 px-3 rounded <?php if($current_page == 'admin/kullanici-loglari') echo 'bg-dark'; ?>">  
  ...
  <div class="offcanvas-body">
    ...
    <ul class="list-unstyled">
      ...
      <li class="mb-2">
        ...
        <ul id="ModSubmenu" class="list-unstyled collapse interrior">
          <a href="https://exeteam.net/admin/lessons" class="text-decoration-none rounded"><li>Ders Yönetimi</li></a>
          <a href="https://exeteam.net/admin/lessons/content" class="text-decoration-none rounded"><li>Kategori Ekle</li></a>
          <a href="https://exeteam.net/admin/lessons/teachers" class="text-decoration-none rounded"><li>Öğretmen Yönetim</li></a>
        </ul>
      </li>
      <li class="mb-2">
        <a class="d-block text-decoration-none py-2 px-3 rounded collapsed" 
        ...
        <ul id="userSubmenu" class="list-unstyled collapse interrior">
          <a href="https://exeteam.net/admin/users/summary" class="text-decoration-none rounded"><li>Kullanıcı Özeti</li></a>
          <a href="https://exeteam.net/admin/users/manage" class="text-decoration-none rounded"><li>Kullanıcılar</li></a>
        </ul>
      </li>
      <li class="mb-2">
        <a href="https://exeteam.net/admin/logs" class="d-block text-decoration-none py-2 px-3 rounded <?php if($current_page == 'admin/kullanici-loglari') echo 'bg-dark'; ?>">  
          <i class="fa-solid fa-clock-rotate-left me-2"></i>Loglar
        </a>
      </li>
    </ul>
    ...
    <div class="" style="min-height: 100vh;">
        <nav class="ust p-1 pe-2 d-flex justify-content-between align-items-center">
            <div class="d-flex align-items-center">
              ...
              <a class="btn" href="https://exeteam.net/kategoriler">
    ...
    <strong class="natifications-title m-2">Bildirimler</strong>
              ...
              <div class="dropdown">
                ...
                <ul class="dropdown-menu profile">
                  <li><a class="dropdown-item" href="profil/profil-düzenle"><i class="fa-regular fa-user me-2"></i>Profili Düzenle</a></li>
                  <li><a class="dropdown-item" href="profil/istatistiklerim"><i class="fa-solid fa-square-poll-vertical me-2"></i></i>İstatistiklerim</a></li>
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content bg-dark">
                      ...
                      <div class="modal-footer">
                        <button onclick="window.location.href='../prepared-features/php/admin/logout.php'" type="button" class="btn btn-danger" data-bs-dismiss="modal">Yine De Çıkmak İstersen Tıkla</button>
                      </div>
                    </div>
                  </div>
            </div>
